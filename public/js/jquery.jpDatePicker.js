...
(function($){
	...
	// jQueryプラグイン
	$.fn.jpDatePicker = function( arg, id ){
		...
		month1.new$ = function(){
			...
			return $(html).on('click','td',function(){
				...
				dateValidate(formatYMD( d ), id);
					dateValidate2(formatYMD( d ), id);
					dateValidate3(formatYMD( d ), id);
						dateValidate4(formatYMD( d ), id);
							dateValidate5(formatYMD( d ), id);
				destroy.call(my);
			})
			.width( this.width );
		};
