function handleCategoryChange(reference, selector = null, C4 = null, C5 = null, C6 = null, E7 = null, E6 = null) {
    ...
    $.ajax({
        ...
        type: "POST",
        url: "gross_profit_adjustment_input/handel-category-kanri/" + bango,
        data: {
...
function fetchCategoryKanriewiseData(parent) {
    ...
    $.ajax({
        ...
        type: "POST",
        url: "gross_profit_adjustment_input/categorykanri-wise-table/" + bango,
        data: {
...
$(document).on("click", "#productSelect", function () {
    ...
    getProductPrice(targetId, pro[1])
...
function getProductPrice(id, productId) {
    ...
    $.ajax({
        ...
        url: 'gross_profit_adjustment_input/product-details/' + bango,
        type: 'POST',
        async: false,
        data: {
            productCd: productId
        ...
        success: function (response) {
            ...
            if (response['status'] == "ok") {
                ...
                $(id).find('.productName').val(product['name']);
