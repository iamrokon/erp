...
Class TxtFormat_2{
    public static function data($bango,$input = null){
        ...
        QueryHelper::runQuery("DROP TABLE IF EXISTS temp_txt_format_2");
        QueryHelper::runQuery("CREATE TEMPORARY TABLE temp_txt_format_2 as
            select distinct 
        ...
        QueryHelper::runQuery("DROP TABLE IF EXISTS txt_format_2");
        QueryHelper::runQuery(
        "CREATE TEMPORARY TABLE txt_format_2 as
        select distinct
        orderhenkan.bango,
        ...
        tuhanorder.text1,
        temp_txt_format_2.sum_of_datachar19,
        temp_txt_format_2.sum_of_dataint04,
        temp_txt_format_2.sum_of_datachar20,
        temp_txt_format_2.patternsub2,
        temp_txt_format_2.checking_patternsub2,
        left((substring(temp_txt_format_2.category5,1,2)::decimal/100)::text,8) as category5

        from orderhenkan
        
        join temp_txt_format_2 on temp_txt_format_2.bango = orderhenkan.bango
        ...
        //$data=DB::table('txt_format_2')->whereRaw("intorder03 >= '$start_date'  AND intorder03 <= '$end_date'" . " AND datachar04 = '1'" . " AND text1 not in('U522','U560')");
        $data=DB::table('txt_format_2');
