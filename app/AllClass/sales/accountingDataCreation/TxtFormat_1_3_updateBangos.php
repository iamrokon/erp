...
Class TxtFormat_1_3_updateBangos{
    public static function data($bango,$input = null){
        ...
        QueryHelper::runQuery("DROP TABLE IF EXISTS txt_format_1_3_updatadata");
        QueryHelper::runQuery("CREATE TEMPORARY TABLE txt_format_1_3_updatadata as
            select distinct 
            orderhenkan.bango,
            tuhanorder.text1,
        ...
        $data=DB::table('txt_format_1_3_updatadata');
