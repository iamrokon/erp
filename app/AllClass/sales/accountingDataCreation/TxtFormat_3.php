...
Class TxtFormat_3{
    public static function data($bango,$input = null){
        ...
        QueryHelper::runQuery("DROP TABLE IF EXISTS temp_txt_format_3");
        QueryHelper::runQuery("CREATE TEMPORARY TABLE temp_txt_format_3 as
            select distinct 
        ...
        QueryHelper::runQuery("DROP TABLE IF EXISTS txt_format_3");
        QueryHelper::runQuery(
        "CREATE TEMPORARY TABLE txt_format_3 as
        select distinct
        orderhenkan.bango,
        ...
        temp_txt_format_3.dataint01,
        temp_txt_format_3.sum_of_dataint04,
        temp_txt_format_3.sum_of_datachar20,
        temp_txt_format_3.patternsub2,
        temp_txt_format_3.checking_patternsub2

        from orderhenkan
        
        join temp_txt_format_3 on temp_txt_format_3.bango = orderhenkan.bango
