...
Class TxtFormat_2_updateBangos{
    public static function data($bango,$input = null){
        ...
        QueryHelper::runQuery("DROP TABLE IF EXISTS txt_format_2_updatedata");
        QueryHelper::runQuery("CREATE TEMPORARY TABLE txt_format_2_updatedata as
            select distinct 
            orderhenkan.bango,
        ...
        $data=DB::table('txt_format_2_updatedata');
