...
Class validateProductSubEditMaster{ 
...
//    $rules['other2'] = ['required','numeric', 'digits_between:1,10',new specialCharValidation];
//    $rules['other3'] = ['required','max:50',new specialCharValidation];
//    $rules['other4'] = ['required','max:50',new specialCharValidation];
...
//    $rules['other25'] = ['required','max:12',new specialCharValidation];
