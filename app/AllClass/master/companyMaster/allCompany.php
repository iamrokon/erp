...
Class allCompany
{
    public static function data($bango, $deleted_item = 2, $userId = null)
    {
        ...
        QueryHelper::runQuery(
            ...
            kokyaku1.fax,
            --kokyaku1.torihikisakibango::int,
            ...
            kokyaku1.yetoiawsestart::int as yetoiawsestart,
            kokyaku1.yetoiawseend,
            kokyaku1.yetoiawsesaiban,
            kokyaku1.denpyostart,
            to_char(kokyaku1.denpyostart,'FM99,999,999,999,999') as formatted_denpyostart,
            ...
            kokyaku1.mail_jyushin::int as mail_jyushin,
            ...
            haisoujouhou.datatxt0058,
            CASE
                WHEN trim(haisoujouhou.datatxt0058 || ' ' || categorykanriDatatxt0058.category4) = '' THEN NULL
                ELSE trim(haisoujouhou.datatxt0058 || ' ' || categorykanriDatatxt0058.category4) END as datatxt0058_detail,

            haisoujouhou.datatxt0059,
            CASE
                WHEN trim(haisoujouhou.datatxt0059 || ' ' || categorykanriDatatxt0059.category4) = '' THEN NULL
                ELSE trim(haisoujouhou.datatxt0059 || ' ' || categorykanriDatatxt0059.category4) END as datatxt0059_detail,

            haisoujouhou.datatxt0060,
            CASE
                WHEN trim(haisoujouhou.datatxt0060 || ' ' || categorykanriDatatxt0060.category4) = '' THEN NULL
                ELSE trim(haisoujouhou.datatxt0060 || ' ' || categorykanriDatatxt0060.category4) END as datatxt0060_detail,

            haisoujouhou.datatxt0061,
            CASE
                WHEN trim(haisoujouhou.datatxt0061 || ' ' || categorykanriDatatxt0061.category4) = '' THEN NULL
                ELSE trim(haisoujouhou.datatxt0061 || ' ' || categorykanriDatatxt0061.category4) END as datatxt0061_detail,
            ...
            haisoujouhou.bunrui6,
            haisoujouhou.bunrui9,
            haisoujouhou.bunrui10::int as bunrui10,
            ...
            from kokyaku1
                ...
                left join categorykanri as categorykanriDatatxt0058
                on substring(haisoujouhou.datatxt0058,1,2) = categorykanriDatatxt0058.category1
                and substring(haisoujouhou.datatxt0058,3,4) = categorykanriDatatxt0058.category2

                left join categorykanri as categorykanriDatatxt0059
                on substring(haisoujouhou.datatxt0059,1,2) = categorykanriDatatxt0059.category1
                and substring(haisoujouhou.datatxt0059,3,4) = categorykanriDatatxt0059.category2

                left join categorykanri as categorykanriDatatxt0060
                on substring(haisoujouhou.datatxt0060,1,2) = categorykanriDatatxt0060.category1
                and substring(haisoujouhou.datatxt0060,3,4) = categorykanriDatatxt0060.category2

                left join categorykanri as categorykanriDatatxt0061
                on substring(haisoujouhou.datatxt0061,1,2) = categorykanriDatatxt0061.category1
                and substring(haisoujouhou.datatxt0061,3,4) = categorykanriDatatxt0061.category2
