...
Class validateProductEdit{ 
  ...
  { 
    ...
    //}else{
    //    $rules['kokyakusyouhinbango'] = ['required','max:5','regex:/^[0-9]+$/',new specialCharValidation,'unique:syouhin1,kokyakusyouhinbango,'.$request['bango'].',bango'];
    //}
   ...
   // $rules['yoyaku'] = ['nullable','max:4','regex:/^[0-9]+$/',new specialCharValidation];
    ...
    $rules['yoyakusu'] = ['nullable','max:8','regex:/^[0-9]+$/']; 
    $rules['yoyakukanousu'] = ['nullable','max:8','regex:/^[0-9]+$/'];
    $rules['sortbango'] = ['nullable','max:8','regex:/^[0-9]+$/']; 
    $rules['dataint01'] = ['nullable','max:8','regex:/^[0-9]+$/']; 
