...
Class AllCreateOrderGrouping{
    public static function data($bango,$request=null){
        ...
        QueryHelper::runQuery("DROP TABLE IF EXISTS create_order_grouping");
        
        QueryHelper::runQuery(
        "CREATE TEMPORARY TABLE create_order_grouping as
        select distinct
        orderhenkan.bango,
        ...
        if($start_information2 != "" && $end_information2 != ""){
            $data=DB::table('create_order_grouping')->whereRaw("kanryoubi >= '$start_date'  AND kanryoubi <= '$end_date'" . " AND substring(information2,1,8) >= '$start_information2'  AND substring(information2,1,8) <= '$end_information2'" . " AND datatxt0122='J310'" . " AND datatxt0125 IS NOT NULL" . " AND datachar24 = '2'");
        }else{
            $data=DB::table('create_order_grouping')->whereRaw("kanryoubi >= '$start_date'  AND kanryoubi <= '$end_date'" . " AND datatxt0122='J310'" . " AND datatxt0125 IS NOT NULL" . " AND datachar24 = '2'");
        }
