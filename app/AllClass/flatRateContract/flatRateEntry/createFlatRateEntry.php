...
Class createFlatRateEntry{
  public static function create($request,$bango,$file=null){
    ...
    if($errors->any() || Input::has('field')){
        ...
        try{
            ...
            $tuhanorder_insert_data = [
                ...
                'datatxt0120' => request('datatxt0120'),
                'syukei5' => 0,
                'date0006' => Carbon::now()->format('Y-m-d H:i:s'),
            ...
            $hikiatesyukko_insert_data = [
                ...
                'datachar23' => 1,
                'datachar24' => $orderhenkan->datachar05,
                'datachar28' => 2,
                'datachar29' => 2,
                'syouhizeiritu' => 1,
                'kanryoubi' => Carbon::now()->format('Y-m-d H:i:s'),
                'syouhinbukacd' => $bango,
            ];
            ...
            for($i=0;$i<count($syouhinbango_arr);$i++){
                ...
                $juchusyukko_insert_data = [
                    ...
                    'dataint19' => $yoteisu,
                    'dataint20' => 1,
                    'datachar24' => $datachar24,
                    //'datachar25' => $syouhinid,
                    'datachar25' => $datachar25,
                    'datachar26' => $datachar26,
                    //'datachar26' => "",
                    'datachar27' => 2,
                    'dataint25' => 0,
                    'recordnumber' => Carbon::now()->format('Y-m-d H:i:s'),
                    'syouhinbukacd' => $bango,
                ];
