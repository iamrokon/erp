...
class AllChangeInChargeOfInHouseWorkWithFixedRateContract
{
    ...
    public static function data($login_bango,$req_data=null)
    {
       ...
       //dd($req_incharge);
        $search_sql = " where soukosyukko.datachar02 = '$req_incharge' AND tuhanorder.datatxt0122 NOT IN ('J320' ,'J330')";    
        ...
        QueryHelper::runQuery("DROP TABLE IF EXISTS all_change_incharge_of_in_house_work_with_fixed_rate_contract_temp ");
        QueryHelper::runQuery("CREATE TEMPORARY TABLE all_change_incharge_of_in_house_work_with_fixed_rate_contract_temp as
            select distinct
            orderhenkan.datachar05 as contractor,	
            ...
            left join tantousya as tantousya_contractor on tantousya_contractor.bango = orderhenkan.datachar05
            ...
            order by contract_number,formatted_sales_destination_r17,formatted_contractor_r17 asc

            ");
         //$display_data = QueryHelper::fetchResult("select * from all_change_incharge_of_in_house_work_with_fixed_rate_contract_temp");
         //dd($display_data);
         return DB::table('all_change_incharge_of_in_house_work_with_fixed_rate_contract_temp');
    }
}
