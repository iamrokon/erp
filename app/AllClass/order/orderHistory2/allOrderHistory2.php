...
Class allOrderHistory2{
    public static function data($login_bango,$deleted_item=2,$req_data=null){
        ...
        QueryHelper::runQuery("DROP TABLE IF EXISTS order_history2_temp");
        ...
        misyukko.yoteimeter,
        COALESCE(SUM(misyukko.dataint05),0) as sum_of_dataint05,
        COALESCE(SUM(misyukko.dataint06),0) as sum_of_dataint06,
        COALESCE(SUM(misyukko.dataint07),0) as sum_of_dataint07
        from misyukko
        ...
        group by misyukko_syouhinid,bango,yoteimeter  
        ");
        
        QueryHelper::runQuery("CREATE TEMPORARY TABLE syukko_temp as
        select 
        orderhenkan.bango,
        orderhenkan.kokyakuorderbango as syukko_syouhinid,
        syukko.yoteimeter,
        COALESCE(SUM(syukko.dataint05),0) as sum_of_dataint05,
        COALESCE(SUM(syukko.dataint06),0) as sum_of_dataint06,
        COALESCE(SUM(syukko.dataint07),0) as sum_of_dataint07
        from syukko
        join orderhenkan on orderhenkan.kokyakuorderbango = syukko.syouhinid
            AND orderhenkan.bango = syukko.orderbango
        where syukko.yoteimeter != 2
        group by kokyakuorderbango,bango,yoteimeter   
        ");

        QueryHelper::runQuery(
        "CREATE TEMPORARY TABLE order_history2_temp as
        select distinct
        ...
        CASE
            ...
            ELSE substring(categorykanriDatachar02.category4,1,4) END as datachar02_detail,
        ...
        concat_ws(' ',housoukubunRequest.syouhinbango,housoukubunRequest.jouhou) as housoukubun,
        CASE
        ...
        --CASE
        --    WHEN orderhenkan.bango = (select max(bango) as max_bango
        --            from orderhenkan as orhn
        --            where orhn.synchroorderbango =0
        --            AND orhn.datachar10 IS NULL
        --            AND orhn.kokyakuorderbango = orderhenkan.kokyakuorderbango
        --        ) THEN coalesce(( SELECT SUM(misyukko.dataint05)
        --            FROM misyukko
        --            where misyukko.syouhinid = orderhenkan.kokyakuorderbango AND orderhenkan.bango = misyukko.orderbango AND misyukko.yoteimeter != 2
        --        ),0)
        --    ELSE coalesce(( SELECT SUM(syukko.dataint05)
        --        FROM syukko
        --        where syukko.syouhinid = orderhenkan.kokyakuorderbango AND syukko.orderbango = orderhenkan.bango AND syukko.yoteimeter != 2
        --    ),0)  END AS sum_of_dataint05,
        ...
        --            AND orhn.datachar10 IS NULL
        --            AND orhn.kokyakuorderbango = orderhenkan.kokyakuorderbango
        --        ) THEN coalesce(( SELECT SUM(misyukko.dataint06)
        --            FROM misyukko
        --            where misyukko.syouhinid = orderhenkan.kokyakuorderbango AND orderhenkan.bango = misyukko.orderbango AND misyukko.yoteimeter != 2
        --        ),0)
        --    ELSE coalesce(( SELECT SUM(syukko.dataint06)
        --        FROM syukko
        --        where syukko.syouhinid = orderhenkan.kokyakuorderbango AND syukko.orderbango = orderhenkan.bango AND syukko.yoteimeter != 2
        --    ),0)  END AS sum_of_dataint06,
        ...
        --            AND orhn.datachar10 IS NULL
        --            AND orhn.kokyakuorderbango = orderhenkan.kokyakuorderbango
        --        ) THEN coalesce(( SELECT SUM(misyukko.dataint07)
        --            FROM misyukko
        --            where misyukko.syouhinid = orderhenkan.kokyakuorderbango AND orderhenkan.bango = misyukko.orderbango AND misyukko.yoteimeter != 2
        --        ),0)
        --    ELSE coalesce(( SELECT SUM(syukko.dataint07)
        --        FROM syukko
        --        where syukko.syouhinid = orderhenkan.kokyakuorderbango AND syukko.orderbango = orderhenkan.bango AND syukko.yoteimeter != 2
        --    ),0)  END AS sum_of_dataint07,
        ...
        syukko_temp.syukko_syouhinid,
        CASE
            WHEN misyukko_temp.misyukko_syouhinid is not null THEN misyukko_temp.sum_of_dataint05
            ELSE syukko_temp.sum_of_dataint05 END as sum_of_dataint05,
        CASE
            WHEN misyukko_temp.misyukko_syouhinid is not null THEN misyukko_temp.sum_of_dataint06
            ELSE syukko_temp.sum_of_dataint06 END as sum_of_dataint06,
        CASE
            WHEN misyukko_temp.misyukko_syouhinid is not null THEN misyukko_temp.sum_of_dataint07
            ELSE syukko_temp.sum_of_dataint07 END as sum_of_dataint07
        ...
        left join misyukko_temp on misyukko_temp.misyukko_syouhinid = orderhenkan.kokyakuorderbango
        AND misyukko_temp.bango = orderhenkan.bango
        
        left join syukko_temp on syukko_temp.syukko_syouhinid = orderhenkan.kokyakuorderbango
        AND syukko_temp.bango = orderhenkan.bango
        ...
        AND housoukubunRequest.color = '0207即時区分'
        ...
        if(isset($req_data['rd1']) && $req_data['rd1']=="rd1_1"){
            //$data=DB::table('order_history2_temp')->whereRaw('ordertypebango2 = ' . 0 ." AND datachar10 IS NULL". " AND (sum_of_dataint05+sum_of_dataint06+sum_of_dataint07) != 0");
            if(isset($req_data['rd3']) && $req_data['rd3']=="rd3_1"){
                //$data=DB::table('order_history2_temp')->whereRaw('maxval = ' . 0 ." AND datachar10 IS NULL AND synchroorderbango != 1 AND substring(datachar01,1,1) = '1' " . " AND sum_of_dataint05 != '0' AND $sql");
                $data=DB::table('order_history2_temp')->whereRaw("ordertypebango2 = maxval AND datachar10 IS NULL AND synchroorderbango != 1 " . " AND sum_of_dataint05 != '0' AND $sql");
                //$data=DB::table('order_history2_temp')->whereRaw("ordertypebango2 = 0 AND datachar10 IS NULL AND synchroorderbango != 1 " . " AND sum_of_dataint05 != '0' AND $sql");
            }else if(isset($req_data['rd3']) && $req_data['rd3']=="rd3_2"){
                //$data=DB::table('order_history2_temp')->whereRaw('maxval = ' . 0 ." AND datachar10 IS NULL AND synchroorderbango != 1 AND substring(datachar01,1,1) = '1' " . " AND sum_of_dataint06 != '0' AND $sql");
                $data=DB::table('order_history2_temp')->whereRaw("ordertypebango2 = maxval AND datachar10 IS NULL AND synchroorderbango != 1 " . " AND sum_of_dataint06 != '0' AND $sql");
                //$data=DB::table('order_history2_temp')->whereRaw("ordertypebango2 = 0 AND datachar10 IS NULL AND synchroorderbango != 1 " . " AND sum_of_dataint06 != '0' AND $sql");
            }else if(isset($req_data['rd3']) && $req_data['rd3']=="rd3_3"){
                //$data=DB::table('order_history2_temp')->whereRaw('maxval = ' . 0 ." AND datachar10 IS NULL AND synchroorderbango != 1 AND substring(datachar01,1,1) = '1' " . " AND sum_of_dataint07 != '0' AND $sql");
                $data=DB::table('order_history2_temp')->whereRaw("ordertypebango2 = maxval AND datachar10 IS NULL AND synchroorderbango != 1 " . " AND sum_of_dataint07 != '0' AND $sql");
                //$data=DB::table('order_history2_temp')->whereRaw("ordertypebango2 = 0 AND datachar10 IS NULL AND synchroorderbango != 1 " . " AND sum_of_dataint07 != '0' AND $sql");
            }else{
                //$data=DB::table('order_history2_temp')->whereRaw('maxval = ' . 0 ." AND datachar10 IS NULL AND synchroorderbango != 1 AND substring(datachar01,1,1) = '1' AND $sql");
                $data=DB::table('order_history2_temp')->whereRaw("ordertypebango2 = maxval AND datachar10 IS NULL AND synchroorderbango != 1 AND $sql");
                //$data=DB::table('order_history2_temp')->whereRaw("ordertypebango2 = 0 AND datachar10 IS NULL AND synchroorderbango != 1 AND $sql");
            }
        }elseif(isset($req_data['rd1']) && $req_data['rd1']=="rd1_2"){
            //$data=DB::table('order_history2_temp')->whereRaw('ordertypebango2 != ' . 0 ." AND datachar10 IS NULL". " AND (sum_of_dataint05+sum_of_dataint06+sum_of_dataint07) != 0");
            if(isset($req_data['rd3']) && $req_data['rd3']=="rd3_1"){
               $data=DB::table('order_history2_temp')->whereRaw('ordertypebango2 != ' . 0 ." AND datachar10 IS NULL AND substring(datachar01,1,1) != '1' " . " AND sum_of_dataint05 != '0' AND $sql");
            }else if(isset($req_data['rd3']) && $req_data['rd3']=="rd3_2"){
               $data=DB::table('order_history2_temp')->whereRaw('ordertypebango2 != ' . 0 ." AND datachar10 IS NULL AND substring(datachar01,1,1) != '1' " . " AND sum_of_dataint06 != '0' AND $sql");
            }else if(isset($req_data['rd3']) && $req_data['rd3']=="rd3_3"){
               $data=DB::table('order_history2_temp')->whereRaw('ordertypebango2 != ' . 0 ." AND datachar10 IS NULL AND substring(datachar01,1,1) != '1' " . " AND sum_of_dataint07 != '0' AND $sql");
            }else{
                $data=DB::table('order_history2_temp')->whereRaw('ordertypebango2 != ' . 0 ." AND datachar10 IS NULL AND substring(datachar01,1,1) != '1' AND $sql");
            }
        }elseif(isset($req_data['rd1']) && $req_data['rd1']=="rd1_3"){
            //$data=DB::table('order_history2_temp')->whereRaw('datachar10 IS NULL'. " AND (sum_of_dataint05+sum_of_dataint06+sum_of_dataint07) != 0");
            if(isset($req_data['rd3']) && $req_data['rd3']=="rd3_1"){
                $data=DB::table('order_history2_temp')->whereRaw('datachar10 IS NULL' . " AND sum_of_dataint05 != '0' AND $sql");
            }else if(isset($req_data['rd3']) && $req_data['rd3']=="rd3_2"){
                $data=DB::table('order_history2_temp')->whereRaw('datachar10 IS NULL' . " AND sum_of_dataint06 != '0' AND $sql");
            }else if(isset($req_data['rd3']) && $req_data['rd3']=="rd3_3"){
                $data=DB::table('order_history2_temp')->whereRaw('datachar10 IS NULL' . " AND sum_of_dataint07 != '0' AND $sql");
            }else{
                $data=DB::table('order_history2_temp')->whereRaw("datachar10 IS NULL AND $sql");
            }
            ...
            $data=DB::table('order_history2_temp')->whereRaw('datachar10 IS NULL' . " AND datachar05 = '$login_bango'" . " AND ordertypebango2 = 0" . " AND intorder01::text between '$start_dt' and '$end_dt' ");
        }
