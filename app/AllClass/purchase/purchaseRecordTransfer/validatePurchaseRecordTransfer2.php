...
class validatePurchaseRecordTransfer2
{
    public static function validate($request,$bango)
    {
        ...
        $rules['order_number_301'] = ['required', 'numeric', 'digits_between:0,10','max:10'];  
        $rules['data_302'] = ['required'];  
        $rules['data_303'] = ['required'];  
