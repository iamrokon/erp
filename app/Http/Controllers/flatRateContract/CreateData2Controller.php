...
class CreateData2Controller extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('flatRateContract.createData2.mainFlatRateDataCreation', compact('bango', 'tantousya', 'B9Data_left','B9Data_right','C1Data_left','C1Data_right','C2Data_left','C2Data_right','personal_datatxt0003','personal_datatxt0004','personal_datatxt0005','datachar05'));
    ...
    public static function orderValidation(Request $request)
    {
        ...
        if ($orderEntry){
            $order_no_sql .= "  where v_orderhenkan.kokyakuorderbango  = '$orderEntry'";
        }
        ...
        $datachar05_sql = '';
        if ($datachar05) {
            $datachar05_sql .= "  and v_orderhenkan.datachar05 = '$datachar05'";

        }

        $checkOrderExistence=QueryHelper::fetchResult("select * from v_orderhenkan $order_no_sql $datachar05_sql $datatxt0003_sql $datatxt0004_sql $datatxt0005_sql");
...
//        dd(self::getKokyakuOrderBango2nd());
        ...
        $company_code=QueryHelper::fetchResult("select tuhanorder.information1 from tuhanorder where tuhanorder.juchubango='$orderEntry'");
        $company_code=$company_code[0]->information1;
//        return [$company_code];
...
//            dd($syouhin1Data,$str);
            if (count($syouhin1Data)>0){
                ...
                $misyukkoResult= QueryHelper::fetchResult("select distinct
                   ...
                   hikiatesyukko.datachar02 as hikiatesyukko_parent_datachar02,
                   hikiatesyukko.datachar03 as hikiatesyukko_parent_datachar03,
                   kakaku.yoyakukanousu,
                   kakaku.sortbango,
                   kakaku.dataint01,
                   kakaku.yoyakusu,
                   kakaku.syutenjyouken,
                   juchusyukko.datachar01
                   from misyukko
                   join juchusyukko
                    on misyukko.syouhinid = juchusyukko.syouhinid and misyukko.syouhinsyu = juchusyukko.syouhinsyu and misyukko.hantei = juchusyukko.hantei
                   join syouhin1
                   ...
                   join hikiatesyukko
                   on hikiatesyukko.syouhinid = misyukko.syouhinid

                   where misyukko.kawasename in  $str
                   and orderhenkan.datachar02 in('U110','U120','U121','U122','U150','U160')
                   and juchusyukko.datachar01 = '2'
                   and syouhin1.data100 = 'D131'
                   and hikiatesyukko.datachar01 = '3'
...
//dd($systemDateTime);
                            ...
                            {
                                if (substr($tantousyaSyozoku->syozoku,0,1)=='1'){
                                    ...
                                    if ($n==0 || $n==1){
                                        ...
                                        if ($n==1){
                                            ...
                                            $hikiatesyukko_insert_data=[
                                                ...
                                                'syouhinid' => $kokyakuorderbango2nd,
                                                'datachar01' => 3,
                                                'datachar02' => $misyukkoResult[$x]->hikiatesyukko_parent_datachar02,
                                                'datachar03' => $misyukkoResult[$x]->hikiatesyukko_parent_datachar03,
                                                'datachar04' => 2,
                                                'datachar05' => null,
                                                'datachar06' => 2,
                                                'datachar07' => null,
