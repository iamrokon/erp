...
class BackListSqlController  extends Controller
{

    public function button_make_table_from_scratch(Request $request)
    {

        return '<a href="/make_table">Make Table</a>';
    }

    public function make_table_from_scratch()
    {
...
");
    ...
    {
        return '<a href="/update_table">Update Table</a>';
    }
