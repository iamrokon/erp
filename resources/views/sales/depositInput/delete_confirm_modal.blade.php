...
<div class="modal custom-data-modal" data-backdrop="static" id="confirm_deposit_input_line_delete" tabindex="-1" role="dialog"
     aria-labelledby="exampleModalLabel1" aria-hidden="true">
    <input type="hidden" id="lineItemId">
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 415px;">
            ...
            <div class="modal-body pt-0 pr-1 pl-1" style="border: 2px solid #fff;" data-bind="nextFieldOnEnter:true">
                ...
                <div class="modal-footer border-top-0 pl-4 pr-4">
                    ...
                    <button type="button" id="close_modal" class="btn bg-teal text-white ml-2" >
                        <!--  <i class="fa fa-hand-paper-o" aria-hidden="true" style="margin-right: 5px;"></i> --> いいえ
                    </button>
                </div>
            </div>
        </div>
