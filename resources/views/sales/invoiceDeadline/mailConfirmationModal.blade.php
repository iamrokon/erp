      ...
      <div class="modal-content bg-blue">
        ...
        <div class="modal-body pt-0 pr-1 pl-1" style="border: 2px solid #fff;" data-bind="nextFieldOnEnter:true">
          <div class="modal-data-box pl-4 pr-4">
            <table class="table text-white" id="table-basic">
              <tbody class="pl-4 pr-4">
                ...
                <tr>
                  <td style="font-size:16px;border-left: 0px !important;padding: 5px 8px 5px 2px !important;border-bottom: 0px !important;">

                    <div class="radio-rounded custom-table-oh d-inline-block">
                      <div class="custom-control custom-radio custom-control-inline" style="padding-left:5px!important;">
                          <input type="radio" class="custom-control-input" id="mail_bill_to" name="" value="" checked="">
                          <label class="custom-control-label" for="mail_bill_to" style="font-size: 16px!important;cursor:pointer;">請求書送付先	</label>
                        </div>
          ...
          <div class="modal-footer border-top-0 pl-4 pr-4">
            ...
            <button type="button" id="send_mail" onclick="sendMail('{{route("invoiceSendMail",[$bango])}}');" class="btn w-145 bg-teal text-white ml-2">
