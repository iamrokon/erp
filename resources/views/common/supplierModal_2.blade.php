    ...
    function sum2() {
        ...
        $.ajax({
            ...
            success: function( response ){
                ...
                //purchaseInput data
                if($("#page_name").length > 0 && $("#page_name").val() == 'paymentInput'){
                    loadPaymentInputData(fillable_id,db_fillable_id,torihikisaki_cd,torihikisaki_details);
                }
                
                //purchaseBalanceList data
                if($("#page_name").length > 0 && $("#page_name").val() == 'purchaseBalanceList'){
                    loadPurchaseBalanceListDependantData(fillable_id,db_fillable_id,torihikisaki_cd,torihikisaki_details);
                }
