<div class="content-head-section custom-mb" style="padding: 13px 0 0;">
    <div class="container position-relative">
        <form id="firstSearch" action="{{ route('changeInchargeOfInHouseWorkWithFixedRateContract') }}" method="post">
        ...
        <input type="hidden" id="fs_sortType" name="sortType" value="{{--isset($old['sortType'])?$old['sortType']:null--}}">-->
            ...
            <input type="hidden" id="source" value="changeInchargeOfInHouseWorkWithFixedRateContract" />
            @csrf
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    @if(isset($exceedChangeInChargeOfInHouseWorkWithFixedRateContract))
                    <p id="no_found_data" class="common_error">{{$exceedChangeInChargeOfInHouseWorkWithFixedRateContract}}</p>
                    @endif
                </div>
            </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td
                                                ...
                                                <div class="line-icon-box float-left mr-3"></div> 内作担当
                                            </td>
                            ...
                            <div class="col-4">
                                <div class="d-inline-block float-right">
                                    ...
                                    onclick="firstSearch('{{ route('changeInchargeOfFixedRateContract') }}',event.preventDefault())" type="submit" class="btn btn-info">表示</button>
                                     -->
                                     <button onclick="firstSearch('{{route('changeInchargeOfInHouseWorkWithFixedRateContract')}}',event.preventDefault())" type="submit" style="width: 150px;height:30px;line-height:30px;" class="btn btn-info">表示</button>
                                     <button id="updateButton" onclick="updateChangeInchargeOfInHouseWorkWithFixedRateContract('{{route('updateChangeInchargeOfInHouseWorkWithFixedRateContract')}}',event.preventDefault())" type="submit" style="width: 150px;height:30px;line-height:30px;" class="btn btn-info">更新</button>
                                </div>
                            </div>
                        </div>
                    </div>
