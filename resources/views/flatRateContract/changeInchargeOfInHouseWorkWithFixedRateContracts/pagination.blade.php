  ...
  <div class="col-7">
      <div class="pagi-content mt-3">
          <table>
              <tbody>
              <tr>
              @if(isset($allChangeInChargeOfInHouseWorkWithFixedRateContract) && $allChangeInChargeOfInHouseWorkWithFixedRateContract->lastPage() > 1)
                 @include('layout.pagination_new.pagination_new1')
              @endif  
                 @include('layout.pagination_new.pagination_new2')
              @if(isset($allChangeInChargeOfInHouseWorkWithFixedRateContract) && $allChangeInChargeOfInHouseWorkWithFixedRateContract->total() > 0)
