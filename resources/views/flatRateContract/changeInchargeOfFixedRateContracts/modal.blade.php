             ...
             <table class="table table-striped modal-table-blue line-transparent table-bordered">
               <tbody>
                 <tr>
                   ...
                   <td class="text-left">
                     <span class="mt-1 text-left">契約担当</span>
                   </td>
                 </tr>
                 <tr>
                   <td>
                   ...
                   <td class="text-left">
                     <span class="mt-1 text-left">定期定額契約番号</span>
                   </td>
                 </tr>
                 <tr>
                   <td>
                   ...
                   <td class="text-left">
                     <span class="mt-1 text-left">契約回数</span>
                   </td>
                 </tr>
                 <tr>
                   <td>
                   ...
                   <td class="text-left">
                     <span class="mt-1 text-left">売上先</span>
                   </td>
                 </tr>
                 <tr>
                   <td>
                 ...
                 <tr>
                   ...
                   <td class="text-left">
                     <span class="mt-1 text-left">新担当</span>
                   </td>
                 </tr>
                 <tr>
                   <td>
                   ...
                   <td class="text-left">
                     <span class="mt-1 text-left">契約金額</span>
                   </td>
                 </tr>
                 <tr>
                   <td>
                 ...
                 <tr>
                   ...
                   <td class="text-left">
                     <span class="mt-1 text-left">伝票備考</span>
                   </td>
                 </tr>
               </tbody>
             </table>
