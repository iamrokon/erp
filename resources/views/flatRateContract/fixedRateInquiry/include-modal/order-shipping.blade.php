<div class="modal custom-data-modal" data-backdrop="static" id="orderShipping" tabindex="-1" role="dialog"
                    ...
                    <table class="table text-white custom-form" id="table-basic">
                        ...
                        <tr>
                            ...
                            <td style="border-left: 0px !important;border-right: 0px !important;width: 840px;padding: 20px 0px !important;">
                                <input type="text" class="form-control" readonly style="border-radius: 4px !important;" value="{{$fixed_rate_inquiry->manufacture_part_number}}" />
                            </td>
                        </tr>
                        <tr>
                            <td
                            ...
                            <td style="border-left: 0px !important;border-right: 0px !important;width: 840px;padding: 20px 0px !important;">
                                <div class="">
                                    <textarea readonly class="form-control" rows="5" id="comment2" style=" resize: none;height: 75px;white-space:normal;border-radius:4px!important;">{{$fixed_rate_inquiry->manufacture_part_name}}</textarea>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="border-left: 0px !important;border-right: 0px !important;width: 840px;padding: 20px 0px !important;">
                                <div class="input-group input-group-sm">
                                    <input type="text" class="form-control" readonly="" value="{{$fixed_rate_inquiry->supplier}}">
                        ...
                        <tr>
                            ...
                            <td style="border-left: 0px !important;border-right: 0px !important;width: 840px;padding: 20px 0px !important;">
                                <input type="text" class="form-control" readonly value="{{\Illuminate\Support\Carbon::parse($fixed_rate_inquiry->order_date)->format("Y/m/d")}}" style="border-radius: 4px !important;"/>
                            </td>
                        </tr>
                        <tr>
                            <td
                            ...
                            <td style="border-left: 0px !important;border-right: 0px !important;width: 840px;padding: 20px 0px !important;">
                                <input type="text" class="form-control"  style="border-radius: 4px !important;" readonly value="{{\Illuminate\Support\Carbon::parse($fixed_rate_inquiry->individual_delivery_date)->format("Y/m/d")}}"/>
                            </td>
                        </tr>
                        <tr>
                            <td style="border-left: 0px !important;border-right: 0px !important;width: 150px;padding-left: 0px;">
                            ...
                            <td style="border-left: 0px !important;border-right: 0px !important;width: 840px;padding: 20px 0px !important;">
                                <div class="input-group input-group-sm">
                                    <input type="text" class="form-control" readonly value="{{$fixed_rate_inquiry->delivery_destination}}"/>
                        ...
                        <tr>
                            <td
                                style="vertical-align:middle !important;border-left: 0px !important;border-right: 0px !important;;width: 150px;padding-left: 0px;padding-top: 24px !important;">
                            ...
                            <td
                                ...
                                <div class="">
                                <textarea class="form-control" rows="5" id="comment2"
                                style=" resize: none;height: 75px;white-space:normal;border-radius:4px!important;"
                                readonly>{{$fixed_rate_inquiry->order_shipping_remarks}}</textarea>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="border-left: 0px !important;border-right: 0px !important;border-bottom:0px !important;width: 840px;padding: 20px 0px 0px !important;">
                                <input type="text" class="form-control" value="{{$fixed_rate_inquiry->delivery_method}}" readonly />
                            </td>
                        </tr>
                        </tbody>
                    </table>
