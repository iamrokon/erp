...
@endphp
<form id="searchNumberForm" class="support_number_search_partial_html">
        ...
        <div class=" row row_data mb-1">
            <div class="col-7">
                <div class="radio-rounded d-inline-block">
                    ...
                    <div class="custom-control custom-radio custom-control-inline" style="padding-left:11px!important;">
                        <input type="radio" class="custom-control-input customRadio" id="customRadio2" name="rd1" value="rd2" checked>
            ...
            <div class="row mt-2">
                                        ...
                                        <div class="pagi">
                                            <div class="nav_mview">
                                                <nav aria-label="Page navigation example ">
                                                    <ul class="pagination">
                                                        <li class="page-item">
                                                            <a class="page-link backSupportPageLink" aria-label="Previous"
                                                        ...
                                                        <input type="hidden" id="paginationhelper" name="page" value=""
                                                            disabled="disabled">
                                                        <li class="page-item">
                                                            <a class="page-link pageSupportLink" href="#"
                                                        ...
                                                        <li class="page-item">
                                                            <a class="page-link forwardSupportPageLink" href="#"
                                                                aria-label="Next"
                ...
                <div class="col-lg-4">
                    <div class="ml-auto text-right" style="padding-top: 19px;">
                        <button type="button" id="choice_button" class="btn bg-teal uskc-button text-white searchSupportBtn"
                            style="width: 145px;">検&nbsp;&nbsp;索
                        </button>
                        <button type="button" id="" class="btn text-white bg-default uskc-button refreshSupportBtn" style="">
        ...
        <div class="table-scroll-area table-responsive">
            <div class="reference-table" style="margin-top: 14px;">
                {{-- <table class="table border-none modal-inner modal-table-white text-dark bg-white"
                    ...
                    <thead>
                        <tr>
                            <th class="text-white supportColumnSort" id="order_number"
                            ...
                            <th class="text-white supportColumnSort" id="person_name"
                            ...
                            <th class="text-white supportColumnSort" id="sold_to"
                            ...
                            <th class="text-white supportColumnSort" id="end_customer"
                            ...
                            <th class="text-white supportColumnSort" id="orders_subject"
                            ...
                            <th class="text-white supportColumnSort" id="estimate_date"
                        ...
                        <tbody>
                            ...
                            @foreach ($numberSearches as $key => $val)
                                <tr id="{{ $val->order_number }}"
                                    class="show_personal_master_info support_number_search_show">
                                    ...
                                    <input type="hidden" class="search_support_number"
                                        value="{{ $val->support_number ?? null }}">
