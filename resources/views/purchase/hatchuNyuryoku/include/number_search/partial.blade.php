            ...
            <div class="col-7">
                <div class="radio-rounded d-inline-block">
                    <div class="custom-control custom-radio custom-control-inline" style="padding-left:11px!important;">
                        <input type="radio" class="custom-control-input customRadio" id="customRadio" name="rd1" value="rd1" autofocus=""
                            checked="">
                        <label class="custom-control-label text-white" for="customRadio"
                            style="font-size: 12px!important;cursor:pointer;">受 注</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline" style="padding-left:11px!important;">
                        <input type="radio" class="custom-control-input customRadio" id="customRadio2" name="rd1" value="rd2">
                        <label class="custom-control-label text-white" for="customRadio2"
                            style="font-size: 12px!important;cursor:pointer;"> 発 注</label>
                    </div>
            ...
            <div class="row mt-2">
                                        ...
                                        <div class="pagi">
                                            <div class="nav_mview">
                                                <nav aria-label="Page navigation example ">
                                                    <ul class="pagination">
                                                        <li class="page-item">
                                                            <a class="page-link backPageLink" aria-label="Previous"
                                                        ...
                                                        <input type="hidden" id="paginationhelper" name="page" value=""
                                                            disabled="disabled">
                                                        <li class="page-item">
                                                            <a class="page-link pageLink" href="#"
                                                        ...
                                                        <li class="page-item">
                                                            <a class="page-link forwardPageLink" href="#"
                                                                aria-label="Next"
                ...
                <div class="col-lg-4">
                    <div class="ml-auto text-right" style="padding-top: 19px;">
                        <button type="button" id="choice_button" class="btn bg-teal uskc-button text-white searchBtn"
                            style="width: 145px;">検&nbsp;&nbsp;索
                        </button>
                        <button type="button" id="" class="btn text-white bg-default uskc-button refreshBtn" style="">
        ...
        <div class="table-scroll-area table-responsive">
            <div class="reference-table" style="margin-top: 14px;">
                {{-- <table class="table border-none modal-inner modal-table-white text-dark bg-white"
                    ...
                    <thead>
                        <tr>
                            <th class="text-white columnSort" id="order_number"
                            ...
                            <th class="text-white columnSort" id="person_name"
                                style="border-bottom:none !important;background: #363A81 !important;width:209px !important;padding-left:0px !important;padding-right:0px !important;">
                                担当
                            </th>
                            <th class="text-white columnSort" id="sold_to"
                            ...
                            <th class="text-white columnSort" id="end_customer"
                            ...
                            <th class="text-white columnSort" id="orders"
                            ...
                            <th class="text-white columnSort" id="orders_subject"
                            ...
                            <th class="text-white columnSort" id="estimate_date"
                    ...
                    <table id="order_show_table" class="table modal-inner modal-table-white text-dark bg-white"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="line-title" style="height: 30px;background: white;margin-right: 1px;width:209px;">
                                    <input type="text" class="form-control" name="person_name"
                                        value="{{ isset($old['person_name']) ? $old['person_name'] : $tantousya->name ?? '' }}"
                                        style="width: 100% !important;border: 1px solid #E1E1E1 !important;border-radius: 4px !important;">
                                </td>
                                ...
                                <td class="line-title" style="height: 30px;background: white;margin-right: 1px;width:200px;">
                                    <input type="text" class="form-control" name="end_customer"
                                        value="{{ isset($old['end_customer']) ? $old['end_customer'] : $supplierName ?? null }}"
                                        style="border: 1px solid #E1E1E1 !important;border-radius: 4px !important;">
                                </td>
                                <td class="line-title" style="height: 30px;background: white;margin-right: 1px;width:128px;">
                                    <input type="text" class="form-control" name="orders"
                                        ...
                                        style="border: 1px solid #E1E1E1 !important;border-radius: 4px !important;width:95px!important;">
                                </td>
