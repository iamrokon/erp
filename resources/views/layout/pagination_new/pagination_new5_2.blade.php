@php
    if(isset($old2['pagination2'])){
        $numberOfData=$old2['pagination2'];
    }
    elseif(isset($pagi)){
        $numberOfData=$pagi;
    }
...
<td>
    <div class="custom-arrow">
        <select name="pagination2" class="form-control left_select "
            style="width: 95px!important; border:1px solid #e1e1e1 !important;border-radius: 0.25rem!important;"
            onchange="changeByDataAmount('purchaseDataTable');">
...
<td style="width: 255px !important;">
    <div class="d-flex justify-content-end">
        <a href="#" id="openSettingModal2" class="btn btn-warning uskc-button" style="margin-top: 2px; margin-right:1px;" data-toggle="modal" data-target="#">カラム表示設定</a>
    </div>
</td>
