...
<div class="topnav" id="top_navbar_hidden_res">
  ...
  <div class="active_li" style="width: 100%;height: 51px;"><a href="http://127.0.0.1:8000/click" style="color: white; text-decoration: none;">
       ユーザックシステム株式会社
      </a>
...
<!--===================== first li Estimates =====================-->
  ...
  <div class="col-6">
       ...
       <a href="{{url('/salesacceptanceprocessing')}}" title=""><span>売上検収処理</span></a>
 ...
 <span class=" ">予算</span>
  ...
  <div class="col-6">
     ...
     <a href="{{url('/company')}}" title=""><span>会社マスタ </span></a>
                    ...
                    <div id="cssmenu" class="">
                        <div class="row header_area22 ">
                            <div class="col-md-2 col-xs-12">
                                <div href="#" class="mt-3 ">
                                  <a href="{{url('/click')}}" style="color: white; text-decoration: none;"class="left-text-top">
                                    ユーザックシステム株式会社
                                      </a>
                                </div>
                            </div>
                                    ...
                                    <div class="widthli">
                                      ...
                                      <div class="row menu_hover_pad" style="background-color: #29487d;">
                                        <div class="col-md-12" style="background-color:#29487d;">
                                          <a  href="#" title="" class="cool-link "style="width: 69px;"><span> 見積入力</span></a>
      ...
      <i class="fa fa-cubes" aria-hidden="true"></i>&nbsp;
                     ...
                     <ul class="ul_left22">
                        <div class="widthli">
                            <div class="row menu_hover_pad" style="background-color: #29487d;">
                                <div class="col-md-12" style="background-color: #29487d;">
                                    <a href="{{url('/orderentry')}}" title=""class="cool-link"style="width: 142px;"><span> 受注入力(PB)・受注票</span></a>
                                     <a  href="{{url('/orderinquery')}}" title=""class="cool-link"style="width: 96px;"><span>受注照会(PB)</span></a>
                                     <a  href="{{url('/orderdata_capture')}}" title=""class="cool-link"style="width: 104px;"><span>受注データ取込</span></a>
                                    <a  href="" title=""class="cool-link"><span>UIS出荷指示データ作成</span></a>
                                    <a href="{{url('/sales_acceptance_process')}}" title=""class="cool-link"style="width: 93px;"><span>売上検収処理</span></a>
                                        <a href="" title=""class="cool-link"style="width: 81px;"><span>売上検収票</span></a>
                                          <a  href="#" title=""class="cool-link"style="width: 149px;"><span>受注案件別進捗状況照会</span></a>
                                             <a  href="#" title=""class="cool-link"style="width: 137px;"><span>パッケージ別受注照会</span></a>
                 ...
                 <i class="fas fa-handshake" aria-hidden="true"></i>&nbsp;
                     ...
                     <ul class="ul_left22">
                      <div class="widthli" style="width:181px;">
                        <div class="row menu_hover_pad" style="background-color: #29487d;">
                    <div class="col-md-12" style="background-color: #29487d;">
                            <a href="#" title="" class="cool-link" style="
    width: 152px;
"><span>定期定額契約データ作成 </span></a>
                            <a href="#" title="" class="cool-link" style="
    width: 115px;
"><span>定期定額契約入力</span></a>
                            <a href="#" title="" class="cool-link" style="
    width: 115px;
"><span>定期定額契約照会</span></a>
                            <a href="#" title="" class="cool-link" style="
    width: 176px;
"><span>定期定額契約受注データ作成</span></a>
                            <a href="#" title="" class="cool-link" style="
    width: 176px;
"><span>定期定額契約発注データ作成</span></a>
                            <a href="#" title="" class="cool-link" style="
    width: 165px;
"><span>定期定額契約担当変更処理</span></a>
                ...
                <div class="widthli" style="width:308px;">
                  <div class="row menu_hover_pad" style="background-color: #29487d;">
                    <div class="col-md-6" style="background-color: #29487d;">
                      <a href="#" title=""class="cool-link"style="width: 106px;"><span>売上データ作成</span></a>
                      <a href="#" title=""class="cool-link"style="width: 69px;"><span>売上入力</span></a>
                      <a href="#" title=""class="cool-link"style="width: 58px;"><span>納品書</span></a>
                      <a href="#" title=""class="cool-link"style="width: 70px;"><span>売上照会</span></a>
                      <a href="#" title=""class="cool-link"style="width: 143px;"><span>売上承認（営業・上司）</span></a>
                      <a href="#" title=""class="cool-link"style="width: 82px;"><span>請求一覧表</span></a>

                      <a href="#" title=""class="cool-link"style="width: 57px;"><span>請求書</span></a>

                    </div>
                       <div class="col-md-6" style="background-color: #29487d;">
                      <a href="#"  title=""class="cool-link"style="width: 69px;"><span>入金入力</span></a>
                      <a href="#"  title=""class="cool-link"style="width: 82px;"><span>得意先元帳</span></a>
                      <a href="#"  title=""class="cool-link"style="width: 128px;"><span>売上データ会計連携</span></a>
                      <a href="#"  title=""class="cool-link"style="width: 128px;"><span>売上請求締め日更新</span></a>
                      <a href="#"  title=""class="cool-link"style="width: 92px;"><span>組織変更処理</span></a>
                      <a href="#" title=""class="cool-link"style="width: 125px;"><span>与信限度額確認表</span></a>
     ...
     <ul class="ul_left22">
      <div class="widthli"style="width: 172px;">
        <div class="row menu_hover_pad" style="background-color: #29487d;">
          <div class="col-md-12" style="background-color: #29487d;">
            <a href="#" title=""class="cool-link"style="width: 104px;"><span>発注データ作成</span></a>
            <a href="#" title=""class="cool-link"style="width: 69px;"><span>発注入力</span></a>
            <a href="#" title=""class="cool-link"style="width: 115px;"><span>発注照会・発注書</span></a>
            <a href="#" title=""class="cool-link"style="width: 144px;"><span>発注承認（営業・上司）</span></a>
            <a href="#" title=""class="cool-link"style="width: 152px;"><span>サポート依頼データ作成</span></a>
            <a href="#" title=""class="cool-link"style="width: 127px;"><span>社内サポート依頼書</span></a>
            <a href="#" title=""class="cool-link"style="width: 174px;"><span>社内発注データ工数管理連携</span></a>
          </div>
        </div>
      </div>
    </ul>
 ...
 <ul class="ul_left22">
  <div class="widthli" style="width:191px;">
    <div class="row menu_hover_pad" style="background-color: #29487d;">
<div class="col-md-12" style="background-color: #29487d;">
        <a href="#" title="" class="cool-link" style="width: 106px;"><span>仕入データ作成</span></a>
        <a href="#" title="" class="cool-link" style="
    width: 106px;
"><span>仕入データ作成</span></a>
        <a href="#" title="" class="cool-link" style="
    width: 180px;
"><span>仕入予定消込入力（購入入力）</span></a>
        <a href="#" class="cool-link" style="
    width: 70px;
"><span>仕入照会</span></a>
        <a href="#" title="" class="cool-link" style="
    width: 145px;
"><span>仕入承認（営業・上司）</span></a>
        <a href="#" title="" class="cool-link" style="
    width: 82px;
"><span>支払予定表</span></a>
        <a href="#" title="" class="cool-link" style="
                  ...
                  <div class="widthli"style="width:310px;">
                    <div class="row menu_hover_pad" style="background-color: #29487d;">
                      <div class="col-md-5" style="background-color: #29487d;">
                                          <a href="{{url('/company')}}" title="" class="cool-link" style="
    width: 81px;
"><span>会社マスタ </span></a>
                        <a href="{{url('/office')}}" title=""class="cool-link"style="
    width: 92px;
"><span>事業者マスタ</span></a>
                        <a href="{{url('/personal')}}" title=""class="cool-link"style=" width: 90px;"><span>担当者マスタ</span></a>
                        <a href="{{url('/product')}}" title=""class="cool-link"style=" width: 81px;"><span>商品マスタ</span></a>
                        <a href="{{url('/employee')}}" title=""class="cool-link"style=" width: 81px;"><span>社員マスタ</span></a>
                        <a href="#" title=""class="cool-link"style=" width: 81px;"><span>名称マスタ</span></a>
                        <a href="#" title=""class="cool-link"style=" width: 81px;"><span>組織マスタ</span></a>
                      </div>


             <div class="col-md-7" style="background-color: #29487d;">
                        <a href="#" title="" class="cool-link" style="width: 127px;"><span>郵便番号住所マスタ</span></a>

                        <a href="#" title="" class="cool-link" style="width: 138px;"><span>ＳＥＱ番号付番マスタ</span></a>
                        <a href="#" title="" class="cool-link" style="width: 174px;"><span>売上請求先別与信管理マスタ</span></a>
                        <a href="#" title="" class="cool-link" style="width: 147px;"><span>得意先別商品単価マスタ</span></a>
                        <a href="#" title="" class="cool-link" style="width: 100px;"><span>商品サブマスタ</span></a>
                        <a href="#" title="" class="cool-link" style="width: 78px;"><span>業種マスタ</span></a>
 ...
 <ul class="ul_left22">
  ...
  <div class="col-md-12" style="background-color: #29487d;">
        <a href="#" title="" class="cool-link" style="
    width: 204px;
"><span>全社売上実績表（予算・前年対比） </span></a>
        <a href="#" title="" class="cool-link" style="
    width: 218px;
"><span>組織別売上実績表（予算・前年対比）</span></a>
        <a href="#" title="" class="cool-link" style="
    width: 254px;
"><span>営業担当者別売上実績表（予算・前年対比）</span></a>
             ...
             <ul class="ul_left22">
              <div class="widthli">
                ...
                <div class="col-md-12" style="background-color: #29487d;">
                    <a href="#" title="" class="cool-link" style="
    width: 133px;
"><span>書類保管（L-BOOK） </span></a>
                    <a href="#" title="" class="cool-link" style="
    width: 131px;
"><span>売上伝票請求書検索</span></a>
        ...
        <i class="fa fa-users" aria-hidden="true"></i>&nbsp;
                 ...
                 <ul class="ul_left22">
                  <div class="widthli">
                    <div class="row menu_hover_pad" style="background-color: #29487d;">
                      <div class="col-md-12" style="background-color: #29487d;">
                        <a href="#" title=""class="cool-link"><span>顧客情報登録（L-INFO) </span></a>
                      </div>
                    </div>
                  </div>
                </ul>
       ...
       <i class="fa fa-cog" aria-hidden="true"></i>&nbsp;
                 ...
                 <ul class="ul_left22">
                  <div class="widthli">
                    <div class="row menu_hover_pad" style="background-color:#29487d;">
                      <div class="col-md-12" style="background-color:#29487d;  ">
                        <a  href="#" title=""class="cool-link"style="width:118px;"><span>SQL文データ抽出 </span></a>
                      </div>
                    </div>
                  </div>
                </ul>
