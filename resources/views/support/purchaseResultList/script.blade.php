...
$('.datePicker1_1').datepicker({
  ...
  // Start
  $('.datePicker1_3').datepicker({
    language: 'ja-JP',
    format: 'yyyy/mm/dd',
    autoHide: true,
    zIndex: 10,
    offset: 6,
    trigger: '.datePicker1_3'
  });

  $(document).on('change focus', '.datePicker1_3', function () {
    if ($(this).val().length == 10) {
      $(this).siblings('.datePickerHidden').val($(this).val());
      let datevalue = $(this).siblings('.datePickerHidden').val();  //getting date value from calendar
      let formatted_date = datevalue.replaceAll('/', '')
  ...
  $(document).on('click', '.datePicker1_3', function () {
    if ($(this).val().length == 0) {
      $(this).datepicker('show');
    }
    else if ($(this).val().length <= 7 ) {
  ...
  $(document).on('keyup', '.datePicker1_3', function (e) {
    let inputDateValue = $(this).val();  //getting date value from input
    if (inputDateValue.length == 8) {
      let slicedYear = inputDateValue.slice(0, 4);
      let slicedMonth = inputDateValue.slice(4, 6);
  ...
  // Update date value with slash on blur
  $(document).on('blur', '.datePicker1_3', function () {
    if ($(this).val() != '') {
      $(this).val($(this).siblings('.datePickerHidden').val());
    } else if ($(this).val() == '') {
      $(this).val('');
  ...
  //Enter press hide dropdown
  $(".datePicker1_3").keydown(function (e) {
    if (e.keyCode == 13) {
      $(".datePicker1_3").datepicker('hide');
    }
  });

  $('.datePicker1_4').datepicker({
    language: 'ja-JP',
    format: 'yyyy/mm/dd',
    autoHide: true,
    zIndex: 10,
    offset: 6,
    trigger: '.datePicker1_4'
  });

  $(document).on('change focus', '.datePicker1_4', function () {
    if ($(this).val().length == 10) {
      $(this).siblings('.datePickerHidden').val($(this).val());
      let datevalue = $(this).siblings('.datePickerHidden').val();  //getting date value from calendar
      let formatted_date = datevalue.replaceAll('/', '')
  ...
  $(document).on('click', '.datePicker1_4', function () {
    if ($(this).val().length == 0) {
      $(this).datepicker('show');
    }
    else if ($(this).val().length <= 7 ) {
  ...
  $(document).on('keyup', '.datePicker1_4', function (e) {
    // $(this).datepicker('hide');
    let inputDateValue = $(this).val();  //getting date value from input
    if (inputDateValue.length == 8) {
      let slicedYear = inputDateValue.slice(0, 4);
  ...
  // Update date value with slash on blur
  $(document).on('blur', '.datePicker1_4', function () {
    if ($(this).val() != '') {
      $(this).val($(this).siblings('.datePickerHidden').val());
    } else if ($(this).val() == '') {
      $(this).val('');
  ...
  //Enter press hide dropdown
  $(".datePicker1_4").keydown(function (e) {
    if (e.keyCode == 13) {
      $(".datePicker1_4").datepicker('hide');
    }
  });
...
//   });
  ...
  // $('.chk-highlight').parents('signbtn-select').find('th').removeClass('highlight_select')
});
